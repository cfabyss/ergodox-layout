...
cr_coord_map_adore = [
    ...
    [
        # Row 1
        [ 8,  0], [ 6,  0], [ 5,  0], [ 8,  4], [14,  2], [15,  4], [ 7,  2],
        [ 7,  4], [ 7,  6], [10,  4], [ 5,  2], [ 6,  2], [ 7,  0], [ 8,  6],
    ],
    [
        # Row 2
        [12,  0], [12,  2], [10,  0], [ 9,  0], [11,  0], [10, 2], [     ],
        [      ], [11,  2], [ 6,  6], [ 9,  2], [10,  6], [12, 4], [12, 6],
    ],
    [
        # Row 3
        [17,  0], [17,  2], [17,  4], [ 8,  2], [15,  2], [16,  0], [13,  0],
        [13,  2], [16,  2], [ 6,  4], [15,  6], [14,  0], [15,  0], [17,  6],
    ],
    [
        # Row 4
        [20,  0], [20,  2], [19,  0], [18,  0], [19,  2], [], [], [], [],
...
cr_coord_map = cr_coord_map_dvorak
...
def main(base_fn, log_fn, coords = "dvorak", restrict_row = None):

    if coords == "adore":
        global cr_coord_map
        cr_coord_map = cr_coord_map_adore
